   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <p>Gender</p>
            <input type="text" name="gender" placeholder="<?= $fetch_profile['gender']; ?>" maxlength="100" class="box">
            <p>Age</p>
            <input type="text" name="age" placeholder="<?= $fetch_profile['age']; ?>" maxlength="100" class="box">
            <p>update pic</p>
